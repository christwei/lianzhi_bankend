...
public interface MaintainCaseMapper  {
	...
	public PmCaseDTO getMainCaseInfoWithDev(int deviceId) throws DataAccessException;
	public String getMaintainItems(PmCaseDTO caseDto) throws DataAccessException;
	...
	public Integer getPmCaseId(Integer deviceId) throws DataAccessException;
