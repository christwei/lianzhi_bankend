...
public interface StockTKCaseMapper  {
	...
	public int getDeviceNotTKCount( int caseId) throws DataAccessException;
    ...
    public int getStockTKCaseStatus(StockCaseDTO caseDto) throws DataAccessException;
    ...
    public int updStockTKCase(StockTKCaseDTO caseDto) throws DataAccessException;
	...
	public Integer getRecentCaseId(Integer deviceId) throws DataAccessException;
}
