...
public class UserRoleController {
	...
	@RequestMapping(value="/getUsersWithDept",method=RequestMethod.POST)
	public ResponseDTO getUsersWithDept(@RequestBody User user) {
		return userAuthService.getUsersWithDept(user.getDeptId());
	}
	
	@RequestMapping(value="/getUsersWithoutDept",method=RequestMethod.POST)
	public ResponseDTO getUsersWithoutDept(@RequestBody User user) {
		return userAuthService.getUsersWithoutDept(user.getDeptId());
	}
	
	@RequestMapping(value="/confirmUserToDept",method=RequestMethod.POST)
	public ResponseDTO confirmUserToDept(@RequestBody User userRole) {
		ResponseDTO result = userAuthService.confirmUserToDept(userRole);
		return result;
	}
