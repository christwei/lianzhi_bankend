...
public class StockTKCaseController {
	...
	public ResponseDTO delStockTKCase(@RequestBody StockCaseDTO caseDto) {
		return caseService.delStockTKCase(caseDto);
	}
	
	@RequestMapping(value="/getAddButtonAuth",method=RequestMethod.POST)
	public ResponseDTO getAddButtonAuth(@RequestBody StockTKCaseDTO caseDto) {
		return caseService.getAddButtonAuth(caseDto);
	}
