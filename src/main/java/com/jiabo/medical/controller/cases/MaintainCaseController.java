...
public class MaintainCaseController {
	...
	@RequestMapping(value="/getPmCaseInfoWithDev",method=RequestMethod.POST)
	public ResponseDTO getPmCaseInfoWithDev(@RequestBody PmCaseDTO caseDto) {
		return caseService.getPmCaseInfoWithDev(caseDto.getDeviceId());
	}
	
	@RequestMapping(value="/getMaintainItems",method=RequestMethod.POST)
	public ResponseDTO getMaintainItems(@RequestBody PmCaseDTO caseDto) {
		return caseService.getMaintainItems(caseDto);
	}
