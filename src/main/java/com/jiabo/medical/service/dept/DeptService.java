...
public class DeptService {
	...
	public ResponseDTO<List<Department>> getUserDeptTree(int userId) {
		
		ResponseDTO<List<Department>> res = new ResponseDTO<List<Department>>();
		
		List<String> roleNames = userMapper.getRoleName(userId);
		...
		if (roleName.equals(ConstantInfo.ROLE_MANAGER)) {
			...
			depts = departmentMapper.getDeptTree(userId);
			
		} else {
			depts = departmentMapper.getUserDept(userId);
		}
