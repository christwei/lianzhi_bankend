...
public class PmCaseDTO implements Serializable {
	...
	private String pmTemplate; //根据设备id 获取设备类型， 然后再根据设备类型id 和医院id 从模板表tb_pm_device_template里面获取模板信息 
	private String pmResult; // 就是tb_pm_case 的pm_reult 字段
	...
	public void setPmResult(String pmResult) {
